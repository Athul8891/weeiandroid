...
class FullAudioPlayer extends StatefulWidget {
  const FullAudioPlayer({Key? key, required this.playlist, this.autoPlay = true,this.listPlay}) : super(key: key);
    ...
    return MinimalAudioPlayer(
      ...
      child: Column(
        children: [
          ...
          PlaylistView(player: _audioPlayer.player, playlist: widget.playlist)
        ],
      ),
    );
  }
