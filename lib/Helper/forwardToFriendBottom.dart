...
void fwdToFriendBottom(BuildContext context,messageData,path) {
              ...
              Scrollbar(
                child:PaginateFirestore(
                  ...
                  itemBuilder: (context, documentSnapshots, index) {
                    ...
                    print("dataaa");
                    return data != null
                        ? chatListNew(documentSnapshots[index].id,data,index,messageData,data,path)
                        : Container(
                      child: const Center(
...
chatListNew(var docId,var item, int index,var data,var userData,var path) {
    ...
    children: [
      Container(
        ...
        child: ListTile(
          ...
          trailing:SentFwdWidget(path: item['messagePath'],data: data,userData:item[hisId] ,),
