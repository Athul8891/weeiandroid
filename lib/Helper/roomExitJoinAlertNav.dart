...
void roomExitJoinAlertNav(BuildContext context,code,uid) {
        ...
        Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              const Text("This will leave you from this room!", style: size14_500Grey),
                h(25),
                Row(
                  children: [
                    Expanded(
                   ...
                   var rsp = await     deleteJoins(code,uid);
