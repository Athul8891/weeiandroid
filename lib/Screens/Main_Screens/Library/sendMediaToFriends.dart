...
void  sendMediaToFriendBottom(BuildContext context,  mediaType, mediaData) {
              ...
              Scrollbar(
                child:PaginateFirestore(
                  ...
                  itemBuilder: (context, documentSnapshots, index) {
                    ...
                    print("dataaa");
                    return data != null
                        ? chatListNew(documentSnapshots[index].id,data,index, mediaType, mediaData)
                        : Container(
                      child: const Center(
...
chatList(var docId,var item, int index,  mediaType, mediaData) {
          ...
          children: [
            ...
            item['type']=="YMusicBot"? Container(
              ...
              child:  Padding(
                ...
                child: Text("Sent", style: size12_200W),
              ),
            ): SentWidgetMedia(path: (auth.currentUser!.uid +"-"+item['friendUid']),id1: auth.currentUser!.uid,id2: item['friendUid'],mediaType: mediaType,mediaData: mediaData,partnerData: item, )
          ],
        ),
        div()
      ],
...
chatListNew(var docId,var item, int index,  mediaType, mediaData) {
    ...
    children: [
      Container(
        ...
        child: ListTile(
          ...
          trailing:SentWidgetMedia(path: item['messagePath'],id1: auth.currentUser!.uid,id2: item[hisId]['uid'],mediaType: mediaType,mediaData: mediaData,partnerData: item[hisId],),
