...
class BlockedChatScreen extends StatefulWidget {
  @override
  _SessionScreenState createState() => _SessionScreenState();
}

class _SessionScreenState extends State<BlockedChatScreen> {
        ...
        child: Scrollbar(
          ...
          child: PaginateFirestore(
            ...
            query: FirebaseFirestore.instance
                ...
                .where('blockedBy', isEqualTo: auth.currentUser!.uid)
  ...
  Widget emptyList() {
    return Container( height:150,child: Column(
      ...
      children: [
        ...
        Text("No blocked conversations found.", style: size13_600W),
        SizedBox(height: 15,),
