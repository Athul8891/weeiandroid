...
class SavedChat extends StatefulWidget {
  ...
  final messagePath;
  final chatStartTime;
  SavedChat({this.fullData,this.friendUid, this.friendType, this.friendData, this.messagePath, this.chatStartTime});

  @override
  _SessionScreenState createState() => _SessionScreenState();
}

class _SessionScreenState extends State<SavedChat> {
                ...
                GestureDetector(
                  ...
                  child: Row(children: [
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Text("Saved",style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600,color: Colors.white),),
                        //SizedBox(height: 6,),
  ...
  Widget emptyList() {
    return Container( height:150,child: Column(
      ...
      children: [
        ...
        Text("No saved conversations found.", style: size13_600W),
        SizedBox(height: 15,),
                ...
                child: Container(
                  ...
                  : GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.only(
                                          topLeft: auth.currentUser!.uid==item['uId'] ?Radius.circular(5):Radius.circular(15),
                                          bottomLeft:
                                          auth.currentUser!.uid==item['uId'] ? Radius.circular(5) : Radius.circular(5),
                                          bottomRight:
                                          auth.currentUser!.uid==item['uId'] ? Radius.circular(5) : Radius.circular(5),
                                          topRight: auth.currentUser!.uid==item['uId'] ?Radius.circular(15):Radius.circular(5),
                                        ),
                                        color:
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed: () async{
                      showToastSuccess("Unsaved");
                      Navigator.pop(context);
                      var rsp = await unsave(chatPath,docid,data);
