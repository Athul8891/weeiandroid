...
class ChatRequestes extends StatefulWidget {
  @override
  _SessionScreenState createState() => _SessionScreenState();
}

class _SessionScreenState extends State<ChatRequestes> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        //   ),
        // ],
        title: const Text("Message Requests", style: size16_600W),
      ),
      body: Padding(
        ...
        child: Scrollbar(
          ...
          child: PaginateFirestore(
            ...
            query: FirebaseFirestore.instance
                ...
                .where('startChat', isEqualTo: false)
                .where('blocked', isEqualTo: false)
                .where('acceptPending', isEqualTo: auth.currentUser!.uid)
  ...
  Widget emptyList() {
    return Container( height:150,child: Column(
      ...
      children: [
        ...
        Text("No requests found.", style: size13_600W),
        SizedBox(height: 15,),
      ...
      onTap: () {
        ...
        NavigatePage(
            ...
            ChatRoom(
              ...
              chatStartTime:item['stamp'].toString() ,
            ));
      },
      child: Column(
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(item[hisId]['name'].toString(), style: size14_500W),
                    h(5),
                    Text(item['lastMessage'].toString(), style: size14_500Grey),
                  ],
                ),
              )
            ],
