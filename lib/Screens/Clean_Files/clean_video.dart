...
class cleanVideo extends StatefulWidget {
  final alert;
  cleanVideo({this.alert});

  @override
  _cleanMusicState createState() => _cleanMusicState();
}

class _cleanMusicState extends State<cleanVideo> {
  bool chk = false;
              ...
              child: Scrollbar(
                child:  Padding(
                  ...
                  child:   PaginateFirestore(
                    ...
                    query: FirebaseFirestore.instance.collection('Media').where('userId',isEqualTo: auth.currentUser!.uid.toString()).where('fileType',isEqualTo: "VIDEO").orderBy("uploadAt", descending: true),
