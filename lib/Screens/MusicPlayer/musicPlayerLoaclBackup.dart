                      ...
                      playList[currentIndex]['fileType'] ==
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: NetworkImage(
                                  playList[currentIndex]['fileThumb']),
                              fit: BoxFit.cover),
                          borderRadius:
                ...
                intialStart == 'false'
                    ...
                    child: Column(
                      children: [
                        SizedBox(height: 10),
                        Text(
                          playList[currentIndex]['fileName'].toString(),
                          style: size14_600W,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(item['fileName']!=null?item['fileName'].toString():"", style: currentIndex == index?size14_500G:size14_500W),
