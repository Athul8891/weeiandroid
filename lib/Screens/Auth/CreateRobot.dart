...
import 'package:weei/Screens/Auth/Data/createRobot.dart';
...
class CreateRobot extends StatefulWidget {
  final number;
  final email;
  const CreateRobot({this.number,this.email}) ;

  @override
  _Profile_HomeState createState() => _Profile_HomeState();
}

class _Profile_HomeState extends State<CreateRobot> {
            ...
            Center(
                child:   TextButton(
                  ...
                  onPressed:tap==true?null: ()async {
                   ...
                   var rsp = await createRobot(unameController.text,nameController.text,emailController.text,numberController.text,profileUri,type,context);
            ...
            Container(
              child: Flexible(
                child:   DropdownButton<String>(
                  items: <String>['YVideoBot', 'YMusicBot'].map((String value) {
