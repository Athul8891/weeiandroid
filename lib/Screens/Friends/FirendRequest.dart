...
class FriendRq extends StatefulWidget {
...
class _SessionScreenState extends State<FriendRq> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Friend Requests", style: size16_600W),
      ),
        ...
        child:Scrollbar(
         // key: ValueKey(dropdownvalue),
          ...
          child: PaginateFirestore(
            ...
            query: FirebaseFirestore.instance.collection('Friend').doc(auth.currentUser!.uid).collection(auth.currentUser!.uid).where('accepted',isEqualTo:false).where('blocked',isEqualTo:false),
          ...
          Row(
            children: [
              ...
              GestureDetector(onTap: item['uid']==auth.currentUser!.uid?null:()async{
                ...
                var rsp = await acceptFriend(item);
                ...
                child: Container(
                  ...
                  child:  Padding(
                    ...
                    child: Text(item['uid']==auth.currentUser!.uid?"You":"Accept", style: size12_200W),
                  ),
                ),
              )
            ],
